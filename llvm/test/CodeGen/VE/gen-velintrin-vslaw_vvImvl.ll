...
8:                                                ; preds = %5, %8
  ...
  %25 = tail call <256 x double> @llvm.ve.vl.vslaw.vvsmvl(<256 x double> %18, i64 3, <256 x i1> %21, <256 x double> %23, i32 %16)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vslaw.vvsmvl(<256 x double>, i64, <256 x i1>, <256 x double>, i32) #2
