...
9:                                                ; preds = %6, %9
  ...
  %29 = tail call <256 x double> @llvm.ve.vl.vsraw.vvvmvl(<256 x double> %20, <256 x double> %22, <256 x i1> %25, <256 x double> %27, i32 %18)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vsraw.vvvmvl(<256 x double>, <256 x double>, <256 x i1>, <256 x double>, i32) #2
